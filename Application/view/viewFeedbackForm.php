<?php
	/* ================================================
	File Name         	  	: viewFeedbackForm.php
	...
	Javscript Functions   	: loadcomponent.js
	includes			  	: util.php,viewFeedbackInner.php

	==================================================*/
     require 'viewFeedbackFormInner.php';
?>
                    ...
                    <table class="table  table-bordered table-hover">
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr <?php echo $style;?>>
                                <td class="noPrint">
                                  <label class="position-relative">
                                        <input type="checkbox" class="ace chkItem" value="<?php echo $row['INT_FEEDBACK_ID'];?>"><span class="lbl"></span>
                                        <input type="hidden" id="hdnPubStatus<?php echo $row['INT_FEEDBACK_ID'];?>" name="hdnPubStatus<?php echo $row['INT_FEEDBACK_ID'];?>" value="<?php echo $row['INT_PUBLISH_STATUS'];?>"/>
                                   </label>
                                </td>
                                <td> <?php  echo $ctr;?></td>
                                <td><?php  echo date("d-M-Y", strtotime($row['DTM_CREATED_ON'])); ?> </td>
                                <td><?php echo htmlspecialchars_decode($row['VCH_NAME'],ENT_NOQUOTES);?> </td>
                                <td><a title="View Feedback" href="javascript:void(0);" onclick="fillFeedback(<?php echo $row['INT_FEEDBACK_ID'];?>)" ><?php echo htmlspecialchars_decode($row['VCH_SUBJECT'],ENT_NOQUOTES);?></a></td>  
                            </tr>
                             <?php } ?>
                        </tbody>
                    </table>
