    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="top_tab_container">
                <?php if ($noAdd != '1') { ?>
                    <a href="<?php echo APP_URL ?>addEvents/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">Add</a>
                <?php } ?>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tbody>
                            <tr <?php echo $style;?>>
                                <td class="noPrint">
                                    <label class="position-relative">
                                        <input type="checkbox" class="ace chkItem" value="<?php echo $row['INT_EVENT_ID']; ?>"><span class="lbl"></span>
                                        <input type="hidden" id="hdnPubStatus<?php echo $row['INT_EVENT_ID']; ?>" name="hdnPubStatus<?php echo $row['INT_EVENT_ID']; ?>" value="<?php echo $row['INT_PUBLISH_STATUS']; ?>"/>
                                    </label>
                                </td>
                                <td><?php echo $ctr; ?></td>
                                <td> 
                                ...
                                <td>
                                    <?php echo htmlspecialchars_decode($row['VCH_LOCATION'],ENT_NOQUOTES); ?>
                                </td>
                                <td> 
                                ...
                                <td>
                                    ...
                                    <img src="<?php echo APP_URL ?>uploadDocuments/Events/<?php echo $row['VCH_IMAGE']; ?>" style="width:100px; height:auto;" alt="<?php echo $row['VCH_IMAGE']; ?>">
                                    <?php }else{ echo "--"; } ?> 
                                </td>                          

                                <td align="center" valign="middle" class="noPrint" style=""><a href="<?php echo APP_URL; ?>addEvents/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['INT_EVENT_ID'];?>"  data-rel="tooltip" title="" data-original-title="Edit" class="btn btn-xs btn-info"> <i class="ace-icon fa fa-pencil bigger-120"></i> </a></td>
                            </tr>
<?php } ?>    
                    </tbody>
                </table>
