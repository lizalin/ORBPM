...
/* ================================================
	...
	==================================================*/
require 'viewLinkInner.php';
?>

<script language="javascript">
	$(document).ready(function() {

		pageHeader = "View Important Link";
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="top_tab_container">
				...
				<?php } ?>
				<a href="javascript:void(0);" class="btn btn-info active">View</a> <a href="<?php echo APP_URL; ?>archieveLink/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">Archive</a>
			</div>
					...
					<table class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th>URL</th>
								<th>Updated On</th>
								<th width="80" class="noPrint" style="<?php echo $editPriv; ?>">Edit</th>
							</tr>
						</thead>
						<tbody>
							<tr>
                          ...
                          <tr <?php echo $style;?>>
                            ...
                            <td align="center" valign="middle" class="noPrint" style="<?php echo $editPriv; ?>"><a href="<?php echo APP_URL?>addLink/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['intLinkId'] ?>" title="Edit" class="btn btn-xs btn-info" data-rel="tooltip" title="" data-original-title="Edit"> <i class="ace-icon fa fa-pencil bigger-120"></i> </a>
                              <!-- <a href="javascript:void(0);" data-rel="tooltip" title="delete" data-original-title="Delete" 
