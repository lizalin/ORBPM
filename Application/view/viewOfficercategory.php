<?php
/* ================================================
    File Name         	  : viewOfficercategory.php
    Description		  : This is used for view Officer Category details.
    Author Name           : Rajesh Kumar Sahoo
    Date Created          : 21-May-2021
    Devloped On           : Rajesh Kumar Sahoo
    Devloped By           : 21-May-2021
    ...
    ==================================================*/
require 'viewOfficercategoryInner.php';
?>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="srvc_hdr_nav " style="right:170px;">
                <a href="<?php echo APP_URL; ?>viewOfficers/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-success btn-sm " data-rel="tooltip" title="" data-original-title="Officers">RAJ BHAVAN Officers</a>
            ...
            <div class="top_tab_container">
                <?php if ($noAdd != '1') { ?>
                    <a href="<?php echo APP_URL ?>addOfficercategory/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">Add</a>
                <?php } ?>
                            ...
                            ?>
                                ...
                                <tr <?php echo $style; ?>>
                                    ...
                                    <td align="center" valign="middle" class="noPrint">
                                        <a href="<?php echo APP_URL ?>addOfficercategory/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['INT_CATEGORY_ID'] ?>" data-rel="tooltip" title="" data-original-title="Edit" class="btn btn-xs btn-info"> <i class="ace-icon fa fa-pencil bigger-120"></i> </a>
