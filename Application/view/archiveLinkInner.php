<?php
    ...
    Description		: This page is used to view act & Rule Details.
	...
	if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
	{
        ...
        if($isPaging==0)	
            $result		= $objLink->manageLink('PG',$intRecno,$strHeadlineE,'','','',0,1,0,0,$strlinkcatType,'');
		  
	else
	{
            $intPgno	= 1;
            $intRecno	= 0;
            $result                 = $objLink->manageLink('V',0,$strHeadlineE,'','','',0,1,0,0,$strlinkcatType,'');
	}
       $totalResult                 = $objLink->manageLink('V',0,$strHeadlineE,'','','',0,1,0,0,$strlinkcatType,'');
