<?php
    /* ================================================
    File Name         	: archieveactandrulesInner.php
    ...
    Functions Used	: manageActRules,deleteActRules
    ==================================================*/
    $obj             = new clsActRules;	
    $isPaging        = 0;
    $pgFlag          = 0;
	...
	if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
	{
        ...
        if($isPaging==0)	
            $result		= $obj->manageActRules('PG',$intRecno,$intCategory,$txthead,'','',0,1,0,0);              
	else
	{
            $intPgno	= 1;
            $intRecno	= 0;
            $result                 = $obj->manageActRules('V',0,$intCategory,$txthead,'','',0,1,0,0);      
	}
       $totalResult                 = $obj->manageActRules('V',0,$intCategory,$txthead,'','',0,1,0,0);      
