<?php
	...
	if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
	{
        ...
        if($isPaging==0)	
            $result		= $objGallery->manageGallery('PG',$intRecno,$intCattype,$intplugintype,$intCategory,0,'','','','','','','',0,0,0,'',$intscreenType);              
	else
	{
            $intPgno	= 1;
            $intRecno	= 0;
            $result                 = $objGallery->manageGallery('V',0,$intCattype,$intplugintype,$intCategory,0,'','','','','','','',0,0,0,'',$intscreenType);      
	}
       $totalResult                 = $objGallery->manageGallery('V',0,$intCattype,$intplugintype,$intCategory,0,'','','','','','','',0,0,0,'',$intscreenType);      
