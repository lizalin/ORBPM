...
/* ================================================
	...
	==================================================*/
require 'archieveImpServicesInner.php';
?>

<script language="javascript">
    $(document).ready(function() {

        pageHeader = "Archive Services";
        ...
        //fillServiceCategory('selCategory','<?php echo $intCategory; ?>');            
        $('[data-rel=tooltip]').tooltip();
        fillActplugin('selCategory', '<?php echo $selplugintype; ?>');
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="top_tab_container">
                ...
                <?php } ?>
                <a href="<?php echo APP_URL; ?>viewImpServices/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info ">View</a> <a href="javascript:void(0);" class="btn btn-info active">Archive</a>
            </div>
            ...
            <div class="searchTable">
                <div class="form-group">
                    ...
                    <label class="col-sm-2  col-lg-1 control-label no-padding-right" for="txtHead">Headline</label>
                    <div class="col-sm-3">
                        <span class="colon">:</span>
                        <input type="text" id="txtHead" name="txtheadE" class="form-control" value="<?php echo $txthead; ?>">
                    </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr <?php echo $style; ?>>
                                        ...
                                        <td> <?php echo $ctr; ?></td>
                                        <td><?php echo htmlspecialchars_decode($row['vchServiceNameE'], ENT_NOQUOTES); ?> </td>
