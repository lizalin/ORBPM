<?php
	...
	if($isPaging==0 && @$_REQUEST['hdn_PageNo']=='' && @$_REQUEST['ID']>0)
	{
        ...
        if($isPaging==0)	
            $result		= $objTender->manageTender('PG',$intRecno,$strTenderNo,$strHeadline,'0000-00-00','0000-00-00','','',0,0,0,0);
		  
	    else
	    {
            $intPgno	= 1;
            $intRecno	= 0;
            $result                 = $objTender->manageTender('V',0,$strTenderNo,$strHeadline,'0000-00-00','0000-00-00','','',0,0,0,0);
	    }
       $totalResult                 = $objTender->manageTender('V',0,$strTenderNo,$strHeadline,'0000-00-00','0000-00-00','','',0,0,0,0);
