...
//print_r($_REQUEST);exit;selCat
	...
	if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
	{
        ...
        if($isPaging==0)	
            $result		= $obj->manageDirectory('PG',$intRecno,$selplugintype,$txthead,$txtdesg,'','','','','','','','',0,2,0,0,$selCat);              
	else
	{
            $intPgno	= 1;
            $intRecno	= 0;
            $result                 = $obj->manageDirectory('V',0,$selplugintype,$txthead,$txtdesg,'','','','','','','','',0,2,0,0,$selCat);     
	}
       $totalResult                 = $obj->manageDirectory('V',0,$selplugintype,$txthead,$txtdesg,'','','','','','','','',0,2,0,0,$selCat);     
