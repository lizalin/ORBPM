<?php
    /* ================================================
    File Name         	  : archieveTender.php
    Description		  : This is used for view archived Tenders.
    Author Name           : T Ketaki Debadarshini
    Date Created          : 15-Sept-2015
    Devloped On           : 15-Sept-2015
    Devloped By           : T Ketaki Debadarshini
    Update History	  : <Updated by>		<Updated On>		<Remarks>

    Style sheet           : bootstrap.min.css, font-awesome.min.css, ace.min.css, custom.css
    Javscript Functions   : jquery.min.js, bootstrap.min.js, custom.js, loadcomponent.js
    includes		  : header.php, navigation.php, util.php, footer.php,archieveTenderInner.php

    ==================================================*/
    require 'archieveTenderInner.php';
?>
                        ...
                        <?php while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr <?php echo $style;?>>
                                ...
                                <td> <?php if($row['VCH_DESCRIPTION_E']!=''){?>
                                    ...
                                    <?php }else{  echo htmlspecialchars_decode($row['VCH_HEAD_LINE_E'],ENT_NOQUOTES);}?>
                                </td> 
